...
> Note
> WireGuard remains the recommended way to connect your web server and workers privately. Workers now upload clips and compilations directly via HTTP API during task execution, eliminating the need for rsync or SMB shares.
