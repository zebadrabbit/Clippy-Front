...
- Files: All documentation is now in uppercase `.MD` format (e.g., `WORKER_SETUP.MD`, `WIREGUARD.MD`, `TIERS-AND-QUOTAS.MD`).
...
## See also
- Documentation in `docs/` directory (all files now use uppercase `.MD` extension)
