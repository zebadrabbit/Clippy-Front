...
class PlatformPreset(Enum):
    ...
    def get_settings(self) -> dict:
        ...
        Returns are cached for performance (10-20ms savings per lookup).
        ...
        @cache.memoize(timeout=3600)  # Cache for 1 hour (rarely changes)
        def _get_preset_settings(preset_value: str) -> dict:
            settings = {
                "youtube": {
                    "width": 1920,
                    "height": 1080,
            ...
            return settings.get(preset_value, settings["custom"])

        return _get_preset_settings(self.value)
